...
wget http://stash.osgconnect.net/+zguan/cmssw_setup.sh
...
wget --no-check-certificate --progress=bar "http://stash.osgconnect.net/+zguan/Wjets/condor/SMP-RunIIFall18wmLHEGS-00059_1_cfg.py"  || exit_on_error $? 150 "Could not download sandbox1."
