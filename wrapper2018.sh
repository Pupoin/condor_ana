...
cfg_file="cfg.py"
wget --no-check-certificate "http://stash.osgconnect.net/+zhyuan/cfg_nanogen/SMP-RunIIFall18wmLHEGS-00138-cfg.py"  -O ${cfg_file}|| exit_on_error $? 150 "Could not download cfg file."
...
sed -i "s/fileName = cms.untracked.string('file:SMP-RunIIFall18wmLHEGS-00138.root')/fileName = cms.untracked.string('file:265_${1}_${seed}.root')/" -i ${cfg_file}
# cmsRun ${cfg_file}
